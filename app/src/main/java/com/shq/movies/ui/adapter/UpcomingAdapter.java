...
public final class UpcomingAdapter extends MyAdapter<MovieBean> {
    ...
    private final class ViewHolder extends MyAdapter.ViewHolder {
        ...
        private TextView tv_movie_want;
        private TextView tv_intro;
        private ImageButton bt_favorite;

        private ViewHolder() {
            super(R.layout.item_upcominglist);
            ...
            tv_movie_want = (TextView)findViewById(R.id.tv_movie_want);
        ...
        public void onBindView(int position) {
            ...
            tv_intro.setText(getItem(position).getIntro());
        }
    }
}