...
public final class HighScoreFragment extends MyFragment<MovieListActivity> implements OnRefreshLoadMoreListener,
    ...
    private void getData(boolean isLoadMore) {
        EasyHttp.get(this).api((IRequestApi) new QueryMovieApi().setName(null).setOrder("score").setPage(movieAdapter.getPageNumber()).setPageSize(10)).request(new HttpCallback<HttpData<List<MovieBean>>>(this) {
            @Override
