...
import com.shq.movies.http.request.SeenApi;
...
public final class SeenFragment extends MyFragment<MovieListActivity> implements OnRefreshLoadMoreListener,
    ...
    private void getData(boolean isLoadMore) {
        EasyHttp.get(this).api(new SeenApi().setPage(movieAdapter.getPageNumber()).setPageSize(10)).request(new HttpCallback<HttpData<List<MovieBean>>>(this) {
            @Override
